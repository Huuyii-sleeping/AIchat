<template>
  <div class="message-input h-full flex flex-col">
    <textarea
      class="input-area pt-4 px-2 flex-auto w-full text-tx-primary placeholder:text-tx-secondary"
      :value="message"
      @input="message = ($event!.target as any).value"
      @focus="fucused = true"
      @blur="fucused = false"
    ></textarea>

    <div class="bottom-bar h-10 flex justify-between items-center p-2 mb-2">
